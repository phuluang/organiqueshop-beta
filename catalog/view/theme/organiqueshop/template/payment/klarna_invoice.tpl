...
$('#button-confirm').on('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#payment').before('<div class="attention"><span class="fa fa-exclamation-triangle fa-lg margin-right10"></span><img src="catalog/view/theme/default/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
		...
		success: function(json) {	
			if (json['error']) {
				$('#payment').before('<div class="warning"><span class="fa fa-exclamation-circle fa-lg margin-right10"></span>' + json['error'] + '</div>');
			}
