...
// Text
$_['text_footer'] = '<a href="http://www.opencart.com">OpenCart</a> &copy; 2009-' . date('Y') . ' All Rights Reserved.<br />Version %s - ภาษาไทยจาก <a href="http://www.siamopencart.com" target="_blank" title="ไปแวะเยี่ยม SiamOpenCart">SiamOpenCart</a>';
?>