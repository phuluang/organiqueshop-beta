...
// Text
$_['text_subject']  = '%s - บัญชีผู้ใช้ของคุณใช้งานได้แล้ว!';
$_['text_welcome']  = 'ยินดีต้อนรับและขอบคุณในการลงทะเบียนที่ %s!';
$_['text_login']    = 'บัญชีของคุณที่ได้สร้างขึ้นกับทางร้านค้าของเรา ตอนนี้สามารถใช้งานได้แล้วโดยใช้ อีเมล์และรหัสผ่านของคุณ โดยไปได้ที่ URL:';
$_['text_services'] = 'หลังจากเข้าระบบ คุณสามารถใช้บริการต่างๆ เช่นดูคำสั่งซื้อที่ผ่านมา พิมพ์ใบอินวอยซ์ แก้ไขข้อมูลส่วนตัว.';
$_['text_thanks']   = 'ขอบพระคุณ,';
?>