...
// Text
$_['text_module']      = 'โมดูล';
$_['text_success']     = 'สำเร็จ: คุณแก้ไข Google Analytics เรียบร้อยแล้ว!';

// Entry
$_['entry_code']       = 'รหัส Analytics :<br /><span class="help">เข้าระบบของคุณ <a onclick="window.open(\'http://www.google.com/analytics/\');"><u>Google Analytics</u></a> หลังจากสร้างบัญชีแล้วก็ ก็อปปี้รหัสมาวางไว้ในส่วนนี้.</span>';
$_['entry_status']     = 'สถานะ:';

// Error
$_['error_permission'] = 'คำเตือน: คุณไม่ได้รับอนุญาติิเข้ามาในส่วนนี้!';
$_['error_code']       = 'ต้องใส่รหัส';
?>